...
- Chat word normalization (e.g., `brb` → `be right back`)
- Tokenization
...
> ✅ **Precision** is the primary evaluation metric, since minimizing false positives (legitimate emails classified as spam) is critical.
...
⚠️ A **higher precision** means the model is better at **not misclassifying legitimate emails**, which is essential in spam detection systems.
